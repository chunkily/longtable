...
The [library](asset-library.md) shipped as a grid embedded in the scene and token dialogs,
...
library still doesn't exist — see [track-removed-asset-hashes](track-removed-asset-hashes.md).
